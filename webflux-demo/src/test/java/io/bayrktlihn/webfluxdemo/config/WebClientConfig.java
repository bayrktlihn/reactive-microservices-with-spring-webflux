...
//  private Mono<ClientResponse> sessionToken(final ClientRequest request, final ExchangeFunction ex) {
//    System.out.println("generating session token");
//    final ClientRequest clientRequest = ClientRequest.from(request).headers(h -> h.setBearerAuth("some-lengthy-jwt")).build();
